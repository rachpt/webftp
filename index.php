...
include($languages_dir . "/zh_cn.php");
...
<div align="center">
    <div id="loginForm" align="left">
        <div id="loginFormTitle">rachpt's  FTP</div>
...
<?php
        echo $lang_username;
?>:
<br><input type="text" name="ftp_user" value="anonymous" size="30" class="<?php
...
<p><?php
        echo $lang_password;
?>:
<br><input type="password" name="ftp_pass" value="rachpt.me" size="30" class="<?php
...
function displayFiles()
{
    ...
    echo "<td width=\"7%\" class=\"ftpTableHeading\">" . getFtpColumnSpan("s", $lang_table_size) . "</td>";
...
function getFileListHtml($array, $image)
{
    ...
    foreach ($array AS $file) {
        ...
        if ($action == "fileAction")
            $html .= "<a href=\"ftp://115.156.215.11" . $file_path . "\" id=\"file" . $i . "\" target=\"_blank\" onContextMenu=\"selectFile(this.id,1); displayContextMenu(event,'" . $file_path . "',''," . assignWinLinNum() . ")\" draggable=\"true\" onDragStart=\"selectFile(this.id,1); setDragFile('" . $file_path . "','')\">" . str_replace(" ","&nbsp;",sanitizeStr($file)) . "</a>";
